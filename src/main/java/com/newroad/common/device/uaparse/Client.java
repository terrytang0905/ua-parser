...
/**
 * Collection of parsed data for a given user agent string consisting of com.iresearch.parseua.UserAgent, com.iresearch.parseua.OS, com.iresearch.parseua.DeviceEntity
 *
