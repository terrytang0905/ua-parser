package com.newroad.common.device.uaparse;
...
/**
 * com.iresearch.parseua.DeviceEntity parser using ua-parser regexes. Extracts device information from user agent strings.
 *
...
public class DeviceParser {
  ...
  protected static DevicePattern patternFromMap(Map<String, String> configMap) {
    ...
    if (regex == null) {
      throw new IllegalArgumentException("com.iresearch.parseua.DeviceEntity is missing regex");
    }
