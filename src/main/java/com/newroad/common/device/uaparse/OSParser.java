...
/**
 * Operating System parser using ua-parser. Extracts com.iresearch.parseua.OS information from user agent strings.
 *
...
public class OSParser {
  ...
  protected static OSPattern patternFromMap(Map<String, String> configMap) {
    ...
    if (regex == null) {
      throw new IllegalArgumentException("com.iresearch.parseua.OS is missing regex");
    }
